...
class MovementRigCamera(Object3D):
    """
    ...
    def __init__(self, units_per_second=1, degrees_per_second=60):
        ...
        self.KEY_MOVE_FORWARDS = "i"
        self.KEY_MOVE_BACKWARDS = "k"
        self.KEY_MOVE_LEFT = "j"
        self.KEY_MOVE_RIGHT = "l"
        self.KEY_MOVE_UP = "o"
        self.KEY_MOVE_DOWN = "p"
        self.KEY_TURN_LEFT = "v"
        self.KEY_TURN_RIGHT = "b"
        self.KEY_LOOK_UP = "n"
